...
func GetRandomSatisfiedChannel(group string, model string, attemptedChannelIDs map[int]struct{}, requestPath string, allowLowestPriorityRepeat bool) (*Channel, error) {
	// if memory cache is disabled, get channel directly from database
	if !common.MemoryCacheEnabled {
		return GetChannel(group, model, attemptedChannelIDs, requestPath, allowLowestPriorityRepeat)
	}
