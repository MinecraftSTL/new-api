...
import { useSelectionColumn } from '@/components/data-table'
...
export function useApiKeysColumns(now: number): ColumnDef<ApiKey>[] {
  ...
  const selectionColumn = useSelectionColumn<ApiKey>()
  return useMemo<ColumnDef<ApiKey>[]>(
    ...
    [t, quotaUnit, now, groupRatios, shouldReduceMotion, locale, justNowLabel, selectionColumn]
  )
}
