	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.PATCH("/passkey/:id", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.PasskeyRename)
				selfRoute.DELETE("/passkey/:id", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.PasskeyDelete)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/batch", controller.BatchUpdateUsers)
		...
		tokenRoute.Use(middleware.TokenOperationAudit())
		{
			...
			tokenRoute.POST("/batch/update", controller.UpdateTokenBatch)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.POST("/batch/update", controller.UpdateRedemptionBatch)
