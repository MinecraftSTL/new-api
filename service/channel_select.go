...
//	         分组B, 优先级1
func cacheGetRandomSatisfiedChannelByPriority(param *RetryParam) (*model.Channel, string, error) {
...
// CacheGetRandomSatisfiedChannel selects an eligible channel while keeping
// attempted channel IDs global across automatic groups.
