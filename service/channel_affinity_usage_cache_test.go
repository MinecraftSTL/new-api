...
var channelAffinityUsageCacheTestID atomic.Uint64

func newChannelAffinityUsageCacheTestIdentity(t *testing.T) (string, string) {
	t.Helper()
	suffix := fmt.Sprintf("%s_%d", t.Name(), channelAffinityUsageCacheTestID.Add(1))
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := newChannelAffinityUsageCacheTestIdentity(t)
	usingGroup := "default"
